...
class MatrixSliceIterator : public MatrixSliceIteratorBase<ConceptMatrix> {
    ...
    operator MatrixSliceIterator<const ConceptMatrix>() const
    { return *(MatrixSliceIterator<const ConceptMatrix>)this; };
    
};

template<class ConceptMatrix>
class MatrixSliceIterator<const ConceptMatrix> : public MatrixSliceIteratorBase<ConceptMatrix> {
    public:
    typedef MatrixSliceIterator<const ConceptMatrix> this_t;
