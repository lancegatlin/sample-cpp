...
#include <iterator>
#include "g_global.h"
#include "g_matrix_algorithm.h"
#include "g_matrix_exception.h"
#include "g_matrix_row.h"
#include "g_matrix_column.h"
#include "g_matrix_iterator.h"
#include "g_matrix_slice_iterator.h"
#include "g_matrix_static_storage.h"
#include "g_matrix_dynamic_storage.h"
#include "g_matrix_adaptor_storage.h"
#include "g_matrix_identity_storage.h"
...
class AnyMatrix : public MatrixStorage {
    ...
    typedef MatrixSliceIterator<const this_t> const_slice_iterator;
    ...
    slice_iterator submatrix(size_t row_begin, size_t column_begin, size_t row_end, size_t column_end)
    { return slice_iterator (this, row_begin, column_begin, row_end, column_end); };
    
    const_slice_iterator submatrix(size_t row_begin, size_t column_begin, size_t row_end, size_t column_end) const
    { return const_slice_iterator(this, row_begin, column_begin, row_end, column_end); };
...
/*
    template<unsigned long ROWS, unsigned long COLUMNS>
    DynamicMatrix(const get_array_t<ROWS,COLUMNS>::array_t &a)
    {
...
class SubMatrix : public MatrixAdaptor<MatrixSliceIterator<ConceptMatrix> > {
    ...
    typedef MatrixSliceIterator<ConceptMatrix> slice_t;
...
template<class ConceptMatrix>
class SubMatrix<const ConceptMatrix> : public MatrixAdaptor<MatrixSliceIterator<const ConceptMatrix> > {
    public:
    typedef SubMatrix<const ConceptMatrix> this_t;
    typedef MatrixAdaptor<MatrixSliceIterator<const ConceptMatrix> > parent_t;
    typedef MatrixSliceIterator<const ConceptMatrix> slice_t;
