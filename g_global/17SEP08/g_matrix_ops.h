...
/*
Commented out due to ambiguity errors with:
AnyMatrix<S> + Row
...
// Column |= ConceptMatrix
template<class ConceptMatrix1, class ConceptMatrix2>
g_global::MatrixRow<ConceptMatrix1> operator |=(g_global::MatrixColumn<ConceptMatrix1> lhs, const ConceptMatrix2 &rhs)
{
    matrix_column_merge(rhs, lhs);
...
// AnyMatrix |= ConceptMatrix
template<class ConceptMatrixStorage, class ConceptMatrix2>
g_global::AnyMatrix<ConceptMatrixStorage> &operator |=(g_global::AnyMatrix<ConceptMatrixStorage> &lhs, const ConceptMatrix2 &rhs)
{
    matrix_column_merge(rhs, lhs);
