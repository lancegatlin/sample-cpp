...
template<class ConceptMatrix>
inline std::ostringstream &operator <<(std::ostringstream &lhs, g_matrix::MatrixRow<const ConceptMatrix> rhs)
{ return g_matrix::matrix_insert(lhs, rhs); }

// extract streamable version of matrix content
template<class ConceptMatrix>
inline std::istringstream &operator >>(std::istringstream &lhs, g_matrix::MatrixRow<ConceptMatrix> rhs)
...
// insert streamable version of matrix content
template<class ConceptMatrix>
inline std::ostringstream &operator <<(std::ostringstream &lhs, g_matrix::MatrixColumn<const ConceptMatrix> rhs)
{ return g_matrix::matrix_insert(lhs, rhs); }

// extract streamable version of matrix content
template<class ConceptMatrix>
inline std::istringstream &operator >>(std::istringstream &lhs, g_matrix::MatrixColumn<ConceptMatrix> &rhs)
{ return g_matrix::matrix_extract(lhs, rhs); }
